...
function serveStatic(app) {
  let distPath = import_path.default.join(__dirname2, "../../public");
  if (!import_fs.default.existsSync(distPath)) {
    distPath = import_path.default.join(process.cwd(), "public");
  }
  if (!import_fs.default.existsSync(distPath)) {
    distPath = "/var/task/public";
  }
  console.log(`[serveStatic] Using distPath: ${distPath}, exists: ${import_fs.default.existsSync(distPath)}`);
  if (!import_fs.default.existsSync(distPath)) {
    console.error(
